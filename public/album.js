...
const getAlbum = async () =>{
  try{
    const response = await axios.get( `https://copia-intro.vercel.app/api/band/${albumId}`)
...
const deleteSong = async (songId) => {
  ...
  try{
   const response = await axios.put(`https://copia-intro.vercel.app/api/band/${albumId}`, albumToUse)
   swal({
    title: 'Success!',
